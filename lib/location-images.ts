...
const LOCATION_IMAGES: Record<string, LocationImage[]> = {
  ...
  'California': [
    ...
    { src: '/location-images/Los Angeles/Destination-Los-Angeles.webp', alt: 'Los Angeles California' },
    { src: '/location-images/San Francisco/San Francisco_6.jpg', alt: 'San Francisco scenic view' },
    { src: '/location-images/San Diego/Hero_San Diego Skyline_John Bahu.jpg', alt: 'San Diego skyline' },
    { src: '/location-images/Sacramento/Sacramento-3X7A2988-Golden1-Cente.e05115f1.fill-1600x900.jpg', alt: 'Sacramento Golden 1 Center' },
    { src: '/location-images/Santa Barbara/aerial-view-ocean-front.jpg', alt: 'Santa Barbara ocean front' },
    { src: '/location-images/San Jose/Living_in_San_Jose_CA.jpg', alt: 'San Jose California' },
    { src: '/location-images/Fresno/PF_Downtown_Fresno_Skyline_04_dfd24056-3371-41ca-a250-1d330e191223.jpg', alt: 'Downtown Fresno skyline' },
    { src: '/location-images/Anaheim/789d214c-1786-4a00-901c-ce2c4c82de8f.webp', alt: 'Anaheim cityscape' },
    { src: '/location-images/Ventura/Ventura_Coast_Waves_Landscape-e1689203129956-1920x925.jpg', alt: 'Ventura coast' },
    { src: '/location-images/Santa Cruz/4d2739d85706d9ffb417d4d154227eba98a0ad91-1600x1066.jpg', alt: 'Santa Cruz scenic view' },
    { src: '/location-images/Monterrey/Big_Sur,_Pacific_Coast,_California,_USA7_(cropped).jpg', alt: 'Big Sur Pacific Coast' },
  ],
  'Colorado': [
  ...
  'Anaheim': [
    { src: '/location-images/Anaheim/789d214c-1786-4a00-901c-ce2c4c82de8f.webp', alt: 'Anaheim cityscape' },
    { src: '/location-images/Anaheim/The-Best-Neighborhoods-for-Commuters-in-Anaheim-1000x500.jpg', alt: 'Anaheim neighborhoods' },
    { src: '/location-images/Anaheim/These-10-Anaheim-CA-Neighborhoods-Are-the-Best-in-the-City.jpg', alt: 'Anaheim best neighborhoods' },
    { src: '/location-images/Anaheim/anaheim-ca-usa-july-26-600nw-2501552791.webp', alt: 'Anaheim California' },
    { src: '/location-images/Anaheim/licensed-image.jpg', alt: 'Anaheim scenic view' },
    { src: '/location-images/Anaheim/newport-beach-at-california-th.jpg', alt: 'Newport Beach near Anaheim' },
  ],
  'Bakersfield': [
    { src: '/location-images/Bakersfield/aerial-view-of-suburban-residential-homes-in-bakersfield-california.jpg', alt: 'Bakersfield suburban aerial view' },
    { src: '/location-images/Bakersfield/bakersfield-best-neighborhood.jpg', alt: 'Bakersfield best neighborhood' },
    { src: '/location-images/Bakersfield/bakersfield-ca-3.avif', alt: 'Bakersfield California' },
    { src: '/location-images/Bakersfield/city-night-AdobeStock_448032826.jpg', alt: 'Bakersfield city at night' },
    { src: '/location-images/Bakersfield/image.jpg', alt: 'Bakersfield scenic view' },
    { src: '/location-images/Bakersfield/image2.jpg', alt: 'Bakersfield landscape' },
  ],
  'Fresno': [
    { src: '/location-images/Fresno/Featured_Destination_Image_c5c80413-9b35-4de4-8a35-5a4ae413bbe7.png', alt: 'Fresno destination' },
    { src: '/location-images/Fresno/Fresno-Brown-Wave-L.webp', alt: 'Fresno scenic view' },
    { src: '/location-images/Fresno/FresnoCA.webp', alt: 'Fresno California' },
    { src: '/location-images/Fresno/Living_in_Fresno_FI.jpg', alt: 'Living in Fresno' },
    { src: '/location-images/Fresno/PF_Downtown_Fresno_Skyline_04_dfd24056-3371-41ca-a250-1d330e191223.jpg', alt: 'Downtown Fresno skyline' },
    { src: '/location-images/Fresno/image.avif', alt: 'Fresno landscape' },
  ],
  'Los Angeles': [
    { src: '/location-images/Los Angeles/5253806go-los-angeles-all-inclusive-wheele.jpg', alt: 'Los Angeles attractions' },
    { src: '/location-images/Los Angeles/Destination-Los-Angeles.webp', alt: 'Destination Los Angeles' },
    { src: '/location-images/Los Angeles/GettyImages-947698310-1729da81e58f40058a9e45ba82532d57-2f992696318c42cbbd595ef3ec1043fd.jpg', alt: 'Los Angeles cityscape' },
    { src: '/location-images/Los Angeles/Inglewood, California.webp', alt: 'Inglewood California' },
    { src: '/location-images/Los Angeles/SoFi_Stadium_2023.jpg', alt: 'SoFi Stadium Los Angeles' },
    { src: '/location-images/Los Angeles/hollywood-boulevard-los-angeles-california.avif', alt: 'Hollywood Boulevard' },
    { src: '/location-images/Los Angeles/iStock-1463288473-1.avif', alt: 'Los Angeles scenic view' },
    { src: '/location-images/Los Angeles/living-in-los-angeles.webp', alt: 'Living in Los Angeles' },
    { src: '/location-images/Los Angeles/los-angeles.jpg', alt: 'Los Angeles skyline' },
    { src: '/location-images/Los Angeles/topic-los-angeles-gettyimages-943489042-feature.avif', alt: 'Los Angeles landscape' },
  ],
  'Modesto': [
    { src: '/location-images/Modesto/1ac839661339f53a760d3ec0cda376ff.jpg', alt: 'Modesto scenic view' },
    { src: '/location-images/Modesto/948cdc71b57a6866433aeadc487b70be.jpg', alt: 'Modesto landscape' },
    { src: '/location-images/Modesto/Modesto-CA-AdobeStock_459839832.webp', alt: 'Modesto California' },
    { src: '/location-images/Modesto/VC-Modesto-gty-531611320-EditRF-1280x640.jpg.webp', alt: 'Modesto cityscape' },
    { src: '/location-images/Modesto/ec101873-city-26442-15c5aa42724.jpg', alt: 'Modesto downtown' },
    { src: '/location-images/Modesto/rawImage.jpg', alt: 'Modesto aerial view' },
  ],
  'Monterrey': [
    { src: '/location-images/Monterrey/685853f0e5dcc4e5df565c3db578360c.jpg', alt: 'Monterey scenic view' },
    { src: '/location-images/Monterrey/90ac5cb0e3b7f250d356da177e12d236.jpg', alt: 'Monterey coastline' },
    { src: '/location-images/Monterrey/95da29a9fec48648bf8ce326f8d2340e.jpg', alt: 'Monterey landscape' },
    { src: '/location-images/Monterrey/Big_Sur,_Pacific_Coast,_California,_USA7_(cropped).jpg', alt: 'Big Sur Pacific Coast' },
    { src: '/location-images/Monterrey/GoCarTours-Activities-you-shouldnt-miss-img1.jpg', alt: 'Monterey activities' },
    { src: '/location-images/Monterrey/image.avif', alt: 'Monterey California' },
  ],
  'Sacramento': [
    { src: '/location-images/Sacramento/09california-briefing-annex-articleLarge.webp', alt: 'Sacramento California' },
    { src: '/location-images/Sacramento/1_th.webp', alt: 'Sacramento scenic view' },
    { src: '/location-images/Sacramento/270381_SCN_Sacramento_iStock-956590696_ZC5F70.webp', alt: 'Sacramento cityscape' },
    { src: '/location-images/Sacramento/Sacramento-3X7A2988-Golden1-Cente.e05115f1.fill-1600x900.jpg', alt: 'Sacramento Golden 1 Center' },
    { src: '/location-images/Sacramento/VC_Blog_RoadTrip_SaltLakeToSacramento_RF_1248279413-1280x640.jpg.webp', alt: 'Sacramento road trip' },
    { src: '/location-images/Sacramento/hero__1200x800____v1222x580__.jpg', alt: 'Sacramento downtown' },
    { src: '/location-images/Sacramento/old-sacramento.jpg', alt: 'Old Sacramento' },
    { src: '/location-images/Sacramento/vacancy-img02@2x-834x626-c.jpg', alt: 'Sacramento neighborhood' },
    { src: '/location-images/Sacramento/vc_spotlightsacramento_sacramento_st_rf_187559989_1280x640.jpg.webp', alt: 'Sacramento spotlight' },
    { src: '/location-images/Sacramento/village-5-sacramento-ca.avif', alt: 'Sacramento village' },
  ],
  'San Bernardino': [
    { src: '/location-images/San Bernardino/265a5e19-2db0-41f3-84f5-577407ce64f5.jpg', alt: 'San Bernardino scenic view' },
    { src: '/location-images/San Bernardino/2842-ca_riv_drnag_81335_230_600x_cfit.jpg', alt: 'San Bernardino landscape' },
    { src: '/location-images/San Bernardino/3a3963e6-6531-421c-8ca9-1ef520e464beee62192fca4d2b86ae_IMG_1849.jpg', alt: 'San Bernardino area' },
    { src: '/location-images/San Bernardino/3fc364fa-city-26595-1687c1aa14f.jpg', alt: 'San Bernardino cityscape' },
    { src: '/location-images/San Bernardino/John-M-Pfau-Library-Calif-California-State.webp', alt: 'Cal State San Bernardino library' },
    { src: '/location-images/San Bernardino/PoiMcDonaldsSldr1.jpg', alt: 'San Bernardino downtown' },
    { src: '/location-images/San Bernardino/rt-sanbernardino-story-hero.jpg', alt: 'San Bernardino mountains' },
    { src: '/location-images/San Bernardino/shutterstock_1559473907.jpg', alt: 'San Bernardino aerial view' },
  ],
  'San Diego': [
    { src: '/location-images/San Diego/1009465-san-diego-at-sunset.jpg', alt: 'San Diego at sunset' },
    { src: '/location-images/San Diego/1456777509.jpg', alt: 'San Diego scenic view' },
    { src: '/location-images/San Diego/Gaslamp_district_(8280047218).jpg', alt: 'San Diego Gaslamp District' },
    { src: '/location-images/San Diego/Hero_San Diego Skyline_John Bahu.jpg', alt: 'San Diego skyline' },
    { src: '/location-images/San Diego/Ocean-Beach-1536x1179.webp', alt: 'San Diego Ocean Beach' },
    { src: '/location-images/San Diego/San+Diego+Aerial+Shot21500x1000.jpg', alt: 'San Diego aerial view' },
    { src: '/location-images/San Diego/San_Diego_Zoo_Entrance_.jpg', alt: 'San Diego Zoo entrance' },
    { src: '/location-images/San Diego/aerial-view-middle-class-townhouse-residential-condos-san-diego-california-usa-216832284.webp', alt: 'San Diego residential area' },
    { src: '/location-images/San Diego/san-diego-embarcadero-sunset-twitter.jpg', alt: 'San Diego Embarcadero sunset' },
    { src: '/location-images/San Diego/san-diego-tourist-attractions-balboa-park-scaled.jpg', alt: 'Balboa Park San Diego' },
  ],
  'San Francisco': [
    { src: '/location-images/San Francisco/0_-_BCC-2023-THINGS-TO-DO-IN-SAN-FRANCISCO-AT-NIGHT-0.webp', alt: 'San Francisco at night' },
    { src: '/location-images/San Francisco/San Francisco_6.jpg', alt: 'San Francisco scenic view' },
    { src: '/location-images/San Francisco/VC_Around-Levis-Stadium_gty-2255009703-RM_1280x640.jpg.webp', alt: 'Levis Stadium San Francisco' },
    { src: '/location-images/San Francisco/cable-cars-downtown-san-francisco.jpg.webp', alt: 'San Francisco cable cars' },
    { src: '/location-images/San Francisco/fac735cb09bf943a2aa990f584e496ec-cc_ft_960.jpg', alt: 'San Francisco cityscape' },
    { src: '/location-images/San Francisco/image.jpg', alt: 'San Francisco landscape' },
    { src: '/location-images/San Francisco/image_f4p8rn61kp6879kotm5mlrof23.webp', alt: 'San Francisco downtown' },
    { src: '/location-images/San Francisco/p2m5ikhq6u1aim7ar0rc.avif', alt: 'San Francisco Golden Gate' },
    { src: '/location-images/San Francisco/san_francisco_suburbs__4088x2385____v1222x580__.jpg', alt: 'San Francisco suburbs' },
    { src: '/location-images/San Francisco/shutterstock_535510594.avif', alt: 'San Francisco skyline' },
  ],
  'San Jose': [
    { src: '/location-images/San Jose/Living_in_San_Jose_CA.jpg', alt: 'Living in San Jose' },
    { src: '/location-images/San Jose/Moving_to_San_Jose_CA_FI.jpg', alt: 'Moving to San Jose' },
    { src: '/location-images/San Jose/erepublic.brightspotcdn.jpg', alt: 'San Jose cityscape' },
    { src: '/location-images/San Jose/san-jose-neighborhoods.jpg', alt: 'San Jose neighborhoods' },
    { src: '/location-images/San Jose/south-san-jose-banner.jpg', alt: 'South San Jose' },
    { src: '/location-images/San Jose/www.usnews.jpg', alt: 'San Jose scenic view' },
  ],
  'Santa Barbara': [
    { src: '/location-images/Santa Barbara/Santa-Barbara-Downtown.png', alt: 'Santa Barbara downtown' },
    { src: '/location-images/Santa Barbara/aerial-view-ocean-front.jpg', alt: 'Santa Barbara ocean front aerial' },
    { src: '/location-images/Santa Barbara/af7239_8e82671cb79544e0a0d5d536b6d376fe~mv2.jpg', alt: 'Santa Barbara scenic view' },
    { src: '/location-images/Santa Barbara/image2.avif', alt: 'Santa Barbara landscape' },
    { src: '/location-images/Santa Barbara/santa-barbara-waterfront-harbor-jsinclair-1.jpg', alt: 'Santa Barbara waterfront harbor' },
    { src: '/location-images/Santa Barbara/vc_spotlight_santabarbara_hero_st_rm_529573764_1280x640.jpg.webp', alt: 'Santa Barbara coastline' },
  ],
  'Santa Cruz': [
    { src: '/location-images/Santa Cruz/4d2739d85706d9ffb417d4d154227eba98a0ad91-1600x1066.jpg', alt: 'Santa Cruz scenic view' },
    { src: '/location-images/Santa Cruz/5627ecba1703854bc553861acc3e6daf.jpg', alt: 'Santa Cruz landscape' },
    { src: '/location-images/Santa Cruz/NEWS_170229752_AR_0_MFQFTTXUJXVZ.webp', alt: 'Santa Cruz cityscape' },
    { src: '/location-images/Santa Cruz/VC_Santa Cruz Beach Boardwalk_SUPPLIED_1280x640.jpg.webp', alt: 'Santa Cruz Beach Boardwalk' },
    { src: '/location-images/Santa Cruz/istockphoto-892499260-612x612.jpg', alt: 'Santa Cruz coastline' },
    { src: '/location-images/Santa Cruz/santa-cruz-ca.avif', alt: 'Santa Cruz California' },
  ],
  'Stockton': [
    { src: '/location-images/Stockton/200122citiesstockton01-editorial.stockton01.jpg', alt: 'Stockton cityscape' },
    { src: '/location-images/Stockton/Aerial_view_of_Stockton,_California_skyline.jpg', alt: 'Stockton aerial skyline' },
    { src: '/location-images/Stockton/GettyImages-171293969.jpg', alt: 'Stockton scenic view' },
    { src: '/location-images/Stockton/downtown-stockton_91852798b59be8b28fc00edfe4aec23a.jpg', alt: 'Downtown Stockton' },
    { src: '/location-images/Stockton/e1aeaf32-80c0-4440-b447-0a32dc4aa037.jpg', alt: 'Stockton landscape' },
    { src: '/location-images/Stockton/shutterstock_2090324101-1024x575.jpg', alt: 'Stockton California' },
  ],
  'Ventura': [
    { src: '/location-images/Ventura/DowntownVenturaNeighborhood-1.jpg', alt: 'Downtown Ventura neighborhood' },
    { src: '/location-images/Ventura/NTcJOo0SY2E9il8l.jpg', alt: 'Ventura scenic view' },
    { src: '/location-images/Ventura/Ventura_Coast_Waves_Landscape-e1689203129956-1920x925.jpg', alt: 'Ventura coast waves' },
    { src: '/location-images/Ventura/old-midtown-ventura.jpg', alt: 'Old midtown Ventura' },
    { src: '/location-images/Ventura/uodk0stx4wahs2dyj4nuqn2b.avif', alt: 'Ventura California' },
    { src: '/location-images/Ventura/ventura-california-1-2.jpg', alt: 'Ventura coastline' },
  ],
  'Miami': [
