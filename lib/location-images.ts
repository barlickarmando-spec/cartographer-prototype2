...
const LOCATION_IMAGES: Record<string, LocationImage[]> = {
  'Alabama': [
    { src: '/location-images/Alabama/Huntsville-skyline-for-Feb-24-2025-story-1536x1024.jpg', alt: 'Huntsville Alabama skyline' },
    { src: '/location-images/Alabama/Opelika_Downtown1-9faa8e7d019f492dbd5299fee0eff3f9.png', alt: 'Opelika downtown' },
    { src: '/location-images/Alabama/Screen-Shot-2018-09-03-at-9.31.39-PM.png', alt: 'Alabama scenic view' },
    { src: '/location-images/Alabama/download.jpg', alt: 'Alabama landscape' },
    { src: '/location-images/Alabama/download (1).jpg', alt: 'Alabama cityscape' },
    { src: '/location-images/Alabama/size_550x415_Talladega Natl Forest Scenic View - what we_re protecting.png', alt: 'Talladega National Forest' },
  ],
  'Alaska': [
    { src: '/location-images/Alaska/48962241_s.webp', alt: 'Alaska scenic view' },
    { src: '/location-images/Alaska/Best-time-to-visit-alaska-6S7A4902-HDR-Pano-scaled.jpg', alt: 'Alaska panorama' },
    { src: '/location-images/Alaska/anchorage-alaska-temple-57454-main.jpg', alt: 'Anchorage Alaska' },
    { src: '/location-images/Alaska/anchorage-skyline-summer-1236-1-HeroSubPage.jpg', alt: 'Anchorage skyline' },
    { src: '/location-images/Alaska/download.jpg', alt: 'Alaska landscape' },
    { src: '/location-images/Alaska/download (1).jpg', alt: 'Alaska wilderness' },
  ],
  'Arizona': [
    { src: '/location-images/Arizona/Arizona 3.jpg', alt: 'Arizona scenic view' },
    { src: '/location-images/Arizona/ScottsdaleAZ-OldTownAtDusk-768x492.jpg.webp', alt: 'Scottsdale Arizona' },
    { src: '/location-images/Arizona/download.jpg', alt: 'Arizona landscape' },
    { src: '/location-images/Arizona/gettyimages-520506217.avif', alt: 'Arizona desert' },
    { src: '/location-images/Arizona/images.jpg', alt: 'Arizona cityscape' },
    { src: '/location-images/Arizona/qUmhXeM1COMBFlSa.jpg', alt: 'Arizona canyon' },
  ],
  'Arkansas': [
    ...
    { src: '/location-images/Arkansas/bigstock-Little-Rock-Arkansas-USA-sky-262314112.jpg', alt: 'Little Rock Arkansas skyline' },
    { src: '/location-images/Arkansas/iStock-1838664029-768x512.jpg.webp', alt: 'Arkansas nature' },
    { src: '/location-images/Arkansas/tumblr_mvlwysxYfZ1s5rl4bo1_1280.jpg', alt: 'Arkansas countryside' },
  ],
  'California': [
  ...
  'Colorado': [
    ...
    { src: '/location-images/Colorado/Denver_skyline.jpg', alt: 'Denver skyline' },
    { src: '/location-images/Colorado/MainStreet1.webp', alt: 'Colorado main street' },
    { src: '/location-images/Colorado/america-s-most-beautiful-mountains-are-in-colorado-but-they-re-not-the-rockies-low-colors.avif', alt: 'Colorado mountains landscape' },
    { src: '/location-images/Colorado/denver-2228783-Header_Mobile.webp', alt: 'Denver cityscape' },
    { src: '/location-images/Colorado/download.jpg', alt: 'Colorado landscape' },
    { src: '/location-images/Colorado/w3840.jpg', alt: 'Colorado nature' },
  ],
  'Connecticut': [
    { src: '/location-images/Connecticut/01LIVING-NEWHAVEN-videoSixteenByNineJumbo1600.jpg', alt: 'New Haven Connecticut' },
    { src: '/location-images/Connecticut/247WallSt.com-247WS-483046-imageforentry7.webp', alt: 'Connecticut scenic view' },
    { src: '/location-images/Connecticut/Collage-Maker-07-Feb-2023-08.38-PM.jpg', alt: 'Connecticut collage' },
    { src: '/location-images/Connecticut/Connecticut 2.jpg', alt: 'Connecticut landscape' },
    { src: '/location-images/Connecticut/Explore-the-beauty-of-Connecticut.jpg', alt: 'Connecticut beauty' },
    { src: '/location-images/Connecticut/Lakeville.jpg', alt: 'Lakeville Connecticut' },
    { src: '/location-images/Connecticut/NewHavenCT-Lighthouse_0-scaled.jpg', alt: 'New Haven lighthouse' },
    { src: '/location-images/Connecticut/download.jpg', alt: 'Connecticut town' },
  ],
  'Delaware': [
    { src: '/location-images/Delaware/1909bs10thingsdelaware-editorial.jpg', alt: 'Delaware scenic view' },
    { src: '/location-images/Delaware/Wilmington-DE-Best-Place-to-Live-in-Delaware.jpg', alt: 'Wilmington Delaware' },
    { src: '/location-images/Delaware/delaware_hero_shutterstock_633468278-1.jpg', alt: 'Delaware coastline' },
    { src: '/location-images/Delaware/istockphoto-510690451-612x612.jpg', alt: 'Delaware landscape' },
  ],
  'District of Columbia': [
    { src: '/location-images/District of Columbia/aerial-view-of-lincoln-memorial-and-washington-monument-2.jpg', alt: 'Lincoln Memorial and Washington Monument' },
    { src: '/location-images/District of Columbia/best-things-to-do-in-Georgetown-1000x533.jpg', alt: 'Georgetown Washington DC' },
    { src: '/location-images/District of Columbia/gettyimages-1133774747.avif', alt: 'Washington DC scenic view' },
    { src: '/location-images/District of Columbia/istockphoto-1437988044-612x612.jpg', alt: 'Washington DC cityscape' },
    { src: '/location-images/District of Columbia/washington-dc-1.jpg', alt: 'Washington DC monuments' },
    { src: '/location-images/District of Columbia/washington-dc-1622643-Header_Mobile.webp', alt: 'Washington DC skyline' },
    { src: '/location-images/District of Columbia/washington_header-42349.jpg', alt: 'Washington DC landscape' },
  ],
  'Florida': [
    { src: '/location-images/Florida/272333_SCN1_Tampa_iStock-599138130_Z5D1AC.webp', alt: 'Tampa Florida' },
    { src: '/location-images/Florida/9ea993d5-24cb-4fcb-86e9-ced4d9090113.webp', alt: 'Florida scenic view' },
    { src: '/location-images/Florida/Copy of Miami Image 4.jpg', alt: 'Miami Florida' },
    { src: '/location-images/Florida/Florida Image 2.jpg', alt: 'Florida landscape' },
    { src: '/location-images/Florida/Miami+-+Chopin+Foundation+of+the+United+States.webp', alt: 'Miami cityscape' },
    { src: '/location-images/Florida/b5d28320-1a52-4455-bdf7-843f380a1c6f-1752871333388-293281.avif', alt: 'Florida coastline' },
    { src: '/location-images/Florida/florida-keys.jpg', alt: 'Florida Keys' },
    { src: '/location-images/Florida/iStock-590299316.avif', alt: 'Florida beach' },
