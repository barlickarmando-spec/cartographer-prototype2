...
// ===== LOCATION FILTER DATA (imported from shared module) =====

import { REGIONS, WEATHER_CATEGORIES, ALL_STATES, STATE_TO_ABBREV, ABBREV_TO_STATE } from '@/lib/location-filters';
